...
echo "services:
  homepage:
    ...
    environment:
      HOMEPAGE_ALLOWED_HOSTS=* # required, may need port. See gethomepage.dev/installation/#homepage_allowed_hosts" | sudo tee -a ./Containers/homepage/compose.yaml > /dev/null 
