...
echo "services:
  homepage:
    ...
    environment:
      HOMEPAGE_ALLOWED_HOSTS: 192.168.0.110:3000 # required, may need port. See gethomepage.dev/installation/#homepage_allowed_hosts" | sudo tee -a ./Containers/homepage/compose.yaml > /dev/null 
